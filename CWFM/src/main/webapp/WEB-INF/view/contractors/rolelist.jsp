...
<title>Contractor Registration List</title>
...
.page-header {
	...
	/* Distribute space between search and buttons */
		...
		<table id="contractorlisttable" cellspacing="0" cellpadding="0">
			<thead>
				<tr>
					...
					<th class="header-text" onclick="sortTable(1)"><spring:message code="label.userId"/><span
						id="sortTransactionid" class="sort-indicator sort-asc">&#x25B2;</span></th>
					<th class="header-text" onclick="sortTable(2)"><spring:message code="label.firstName"/><span
						id="sortUnitcode" class="sort-indicator sort-asc">&#x25B2;</span></th>
					<th class="header-text" onclick="sortTable(3)"><spring:message code="label.lastName"/> <span
						id="sortVendorcode" class="sort-indicator sort-asc">&#x25B2;</span></th>
					<th class="header-text" onclick="sortTable(4)"><spring:message code="label.mobileNumber"/><span
						id="sortContractorname" class="sort-indicator sort-asc">&#x25B2;</span></th>
					<th class="header-text" onclick="sortTable(5)"><spring:message code="label.role"/><span
			...
			<tbody>
				<c:forEach items="${contractorlist}" var="wo">
					<tr>
						<td style="border: 1px solid black;"><input type="checkbox"
							name="selectedWOs" value="${wo.userId}"></td>
							<td style="border: 1px solid black;">${wo.userId}</td>
						<td style="border: 1px solid black;">${wo.firstName}</td>
						<td style="border: 1px solid black;">${wo.lastName}</td>
						<td style="border: 1px solid black;">${wo.contactNumber}</td>
						<td style="border: 1px solid black;">${wo.roleName}</td>
