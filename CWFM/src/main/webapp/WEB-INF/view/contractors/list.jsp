...
<div class="page-header">
   ...
   <form action="/CWFM/contractor/list" method="GET" class="search-container">
        ...
        <thead>
            <tr>
             <td style="border: 1px solid black;">
                ...
                <th class="header-text" >Contractor Code</th>
        ...
        <tbody>
            <c:forEach items="${contList}" var="contList">
                <tr>
                 ...
                 --%>
                 <td style="border: 1px solid black;"><input type="checkbox" name="selectedContractors" value="${contList.contractorId}"></td>
                
                    <td style="border: 1px solid black;">${contList.code}</td>
                      <td style="border: 1px solid black;">${contList.name}</td>
            <td style="border: 1px solid black;">${contList.address}</td>
                </tr>
            </c:forEach>
        </tbody>
    </table>
