...
<body>
	<div class="page-header">
		...
		<button type="button" class="btn btn-default " onclick="exportCSVFormat()">Export</button>
		...
		<table id="contractorlisttable" cellspacing="0" cellpadding="0">
			<thead>
				<tr>
					...
					<th class="header-text" onclick="sortTable(1)"><spring:message code="label.transactioId"/><span
					...
					<th class="header-text" onclick="sortTable(4)"><spring:message code="label.status"/><span
						id="sortContractorname" class="sort-indicator sort-asc">&#x25B2;</span></th>
					<th class="header-text" onclick="sortTable(5)"><spring:message code="label.requestType"/><span
			...
			<tbody>
				<c:forEach items="${contractorlist}" var="wo">
					<tr>
						...
						<td style="border: 1px solid black;">${wo.contractorregId}</td>
						<td style="border: 1px solid black;">${wo.principalEmployer}</td>
						<td style="border: 1px solid black;">${wo.vendorCode}</td>
						<td style="border: 1px solid black;">${wo.contractName}</td>
