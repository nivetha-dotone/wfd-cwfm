...
<div class="page-header">
    ...
    <button id="exportDropdownBtn" class="btn btn-secondary dropdown-toggle" type="button" aria-haspopup="true" aria-expanded="false">
        Export
    </button>
    <div id="exportDropdownMenu" class="dropdown-menu" aria-labelledby="exportDropdownBtn">
        <button class="dropdown-item" onclick="exportData('csv')">Export as CSV</button>
        <button class="dropdown-item" onclick="exportData('excel')">Export as Excel</button>
    </div> -->
</div>
