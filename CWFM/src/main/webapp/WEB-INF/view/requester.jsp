...
<body>
    ...
    <div id="requesterContent">
        <f:form id="requesterForm" action="/CWFM/RequestorCon/saveRequestor" modelAttribute="requesterObj" method="post" enctype="multipart/form-data" autocomplete="off">
            ...
            <table class="form-table" cellspacing="0" cellpadding="0">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="custom-select" id="principalEmployer" name="principalEmployerId" 
                                ...
                                <c:forEach var="pe" items="${PrincipalEmployer}">
                                    <option value="${pe.id}" ${requesterObj.principalEmployer eq pe.id ? 'selected="selected"' : '' }>
                                        ${pe.description}
                                    </option>
                                </c:forEach>
                            </select>
                            <label id="error-principalEmployer" class="error-label">Principal Employer is required</label>
                        </td>
                    </tr>
                        ...
                        <td>
                            <select class="custom-select" id="contractor" name="contractorId">
                                ...
                                <c:forEach var="contractor" items="${Contractors}">
                                    <option value="${contractor.id}" ${requesterObj.contractorId eq contractor.id ? 'selected="selected"' : '' }>
                                        ${contractor.name}
                                    </option>
                                </c:forEach>
                            </select>
                            <label id="error-contractor" class="error-label">Contractor is required</label>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" class="custom-input" id="aadharNumber" name="aadharNumber" 
                                   pattern="[0-9]{12}" maxlength="12" placeholder="Enter 12-digit Aadhar number"
                                   value="${requesterObj.aadharNumber}" 
                                   oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                            <label id="error-aadharNumber" class="error-label">Valid 12-digit Aadhar number is required</label>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="custom-select" id="department" name="departmentId" onchange="getAreabyDept(); getEic();">
                                <option value="">Please select Department</option>
                                <c:forEach var="dept" items="${Departments}">
                                    <option value="${dept.departmentId}" ${requesterObj.department eq dept.departmentId ? 'selected="selected"' : '' }>
                                        ${dept.department}
                                    </option>
                                </c:forEach>
                            </select>
                            <label id="error-department" class="error-label">Department is required</label>
                        </td>
                    </tr>
                        ...
                        <td>
                            <select class="custom-select" id="academic" name="academicId">
                                ...
                                <c:forEach var="option" items="${Academics}">
                                    <option value="${option.gmId}" ${requesterObj.academic eq option.gmId ? 'selected="selected"' : '' }>
                                        ${option.gmName}
                                    </option>
                                </c:forEach>
                            </select>
                            <label id="error-academic" class="error-label">Academic qualification is required</label>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea class="custom-textarea" id="additionalQualification" name="additionalQualification" 
                                      maxlength="300" placeholder="Enter additional qualifications (max 300 words)"
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <label id="error-attachCV" class="error-label">CV attachment is required</label>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="auto-generated-info">
                                <textarea class="custom-textarea" id="shortNote" name="shortNote" readonly 
                                          placeholder="Important information from uploaded document will appear here automatically..."></textarea>
                                <small style="color: #666;">This field is auto-populated based on the uploaded CV</small>
                            </div>
                        </td>
                    </tr>
                </tbody>
            ...
            <div class="action-buttons">
                <button type="button" class="btn btn-secondary" onclick="draftRequester()">Draft</button>
                <button type="button" class="btn btn-success" onclick="saveRequester()">Save</button>
