...
<div class="page-header" method="POST" onsubmit="return validateMasterValue()">
    ...
    <label for="gmTypeId">Select GM Type:</label>
         <select id="gmTypeId" name="gmTypeId" onchange="fetchGmData()" required>
        <option value="">-- Select GM Type --</option>
        ...
        <label for="masterValue">Master Value:</label>
    ...
    <table border="1" >
        ...
        <tbody>
         <c:choose>
            ...
            <c:otherwise>
                <tr>
                    <td colspan="4">No entries available for the selected General Type.</td>
                </tr>
            </c:otherwise>
        </c:choose>
        </tbody>
