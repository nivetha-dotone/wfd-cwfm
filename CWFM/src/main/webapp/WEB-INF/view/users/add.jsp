   ...
   <form id="userFormID">
    <table class="ControlLayout">
        ...
        <tr>
            ...
            <td><input type="text" name="firstName" style="height: 20px;" size="30" maxlength="30" /></td>
            <th><label class="custom-label"><span class="required-field">*</span>Last Name:</label></th>
            <td><input type="text" name="lastName" style="height: 20px;" size="30" maxlength="30" /></td>
        </tr>
        <tr>
             <th><label class="custom-label"><span class="required-field">*</span>Email:</label></th>
        <td><input type="email" name="emailId" style="height: 20px;" size="30" maxlength="30" /></td>
            <th><label class="custom-label"><span class="required-field">*</span>Contact Number:</label></th>
            <td><input type="text" name="contactNumber" style="height: 20px;" size="30" maxlength="30" /></td>
        </tr>
        <tr>
            <th><label class="custom-label"><span class="required-field">*</span>Password:</label></th>
            <td><input type="password" name="password" style="height: 20px;" size="30" maxlength="30" /></td>
            <th><label class="custom-label"><span class="required-field">*</span>User Account:</label></th>
            <td><input type="text" name="userAccount" style="height: 20px;" size="30" maxlength="30" /></td>
        </tr>
        <tr>
