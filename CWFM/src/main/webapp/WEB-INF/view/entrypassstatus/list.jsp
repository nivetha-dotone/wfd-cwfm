...
<select id="principalEmployerId" name="principalEmployerId" style="color:gray;padding:3px;" onchange="loadDepartments(this.value)">
    ...
    <c:forEach items="${principalEmployers}" var="pe">
        ...
        <button type="button" class="btn btn-default process-footer-button-cancel ng-binding"  onclick="searchGatePassReportBasedOnPE()">Search</button>
 <!-- Inline script placed immediately after dropdowns -->
    ...
    <div>
       ...
       <c:if test="${UserPermission.exportRights eq 1 }">
        <button type="button" class="btn btn-default process-footer-button-cancel ng-binding" onclick="exportToEntryPassStatusCSV()">Export</button>
    	</c:if>
...
<tr >
                    ...
                    <th class="header-text"  onclick="sortTable(9)"><spring:message code="label.reportVendorCode"/><span id="sortIndicatorIsmwApp" class="sort-indicator sort-asc"></span></th> 
                     <th class="header-text"  onclick="sortTable(9)"><spring:message code="label.reportVendorName"/><span id="sortIndicatorCode" class="sort-indicator sort-asc"></span></th> 
                     <th class="header-text"  onclick="sortTable(9)"><spring:message code="label.reportWorkorder"/><span id="sortIndicatorCode" class="sort-indicator sort-asc"></span></th> 
                    <th class="header-text"  onclick="sortTable(10)"><spring:message code="label.reportEicNumber"/><span id="sortIndicatorOrganization" class="sort-indicator sort-asc"></span></th> 
                    <th class="header-text"  onclick="sortTable(10)"><spring:message code="label.reportEntryPassAction"/><span id="sortIndicatorOrganization" class="sort-indicator sort-asc"></span></th> 
                    <th class="header-text"  onclick="sortTable(10)"><spring:message code="label.reportEntryPassType"/><span id="sortIndicatorOrganization" class="sort-indicator sort-asc"></span></th> 
                    <th class="header-text"  onclick="sortTable(10)"><spring:message code="label.reportLastApprover"/><span id="sortIndicatorOrganization" class="sort-indicator sort-asc"></span></th> 
                    <th class="header-text"  onclick="sortTable(10)"><spring:message code="label.reportNextApprover"/><span id="sortIndicatorOrganization" class="sort-indicator sort-asc"></span></th> 
                    <th class="header-text"  onclick="sortTable(10)"><spring:message code="label.reportStauts"/><span id="sortIndicatorOrganization" class="sort-indicator sort-asc"></span></th> 
            </tr>
        </thead>
       <tbody id="entryPassReportBodyId">
       </tbody>
    </table></div>
