        ...
        <div class="tabs">
         ...
         <% if (user != null && "Contractor Supervisor".equals(roleName)) { %>
           ...
           <% } %> 
			...
			<% } %>
            <button type="submit" class="btn btn-default process-footer-button-cancel ng-binding" onclick="loadCommonList('/contractworkmen/blackList', 'Black List');">Cancel</button>
        </div> 
    </div>
