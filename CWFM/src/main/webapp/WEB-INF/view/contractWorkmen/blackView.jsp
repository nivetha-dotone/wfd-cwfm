        ...
        <div class="tabs">
         ...
         <% if (user != null && "Contractor".equals(roleName)) { %>
           ...
           <% } %> 
            ...
            <% if (user != null && !"Contractor".equals(roleName)) { %>
    			<button id="approveButton"  type="submit" class="btn btn-default process-footer-button-cancel ng-binding" onclick="approveRejectBlack('4','6')">Approve</button>
   				 <button id="rejectButton"   type="submit" class="btn btn-default process-footer-button-cancel ng-binding" onclick="approveRejectBlack('5','6')">Reject</button>
			<% } %>
	...
	<td><input style="width: 100%;height: 20px;" type="text"  name="pfCap"  id="pfCap" value="${GatePassObj.pfCap }" readonly/></td>
            ...
            value="${GatePassObj.policeVerificationDate }" readonly>
            		...
            		<tr>
                		...
                		<td>
                    	 <a href="#" onclick="viewDoc('${GatePassObj.transactionId}', '${GatePassObj.createdBy}', 'training')">View Training Document</a>
                		</td>
            		</tr>
      				</c:if>
