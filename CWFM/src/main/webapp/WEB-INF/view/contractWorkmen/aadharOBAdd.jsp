...
<h2>Enter Aadhar Number</h2>
    <f:form id="aadharForm" modelAttribute="aadharModel" method="post" action="/CWFM/contractworkmen/submitAadhar">
    ...
    <h2>Enter OTP</h2>
    <f:form id="otpForm" modelAttribute="otpModel" method="post" action="/CWFM/contractworkmen/validateOTP">
