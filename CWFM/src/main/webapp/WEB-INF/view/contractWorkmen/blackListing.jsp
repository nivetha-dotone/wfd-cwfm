...
<select id="deptId" name="deptId" style="color:gray;padding:3px;">
    ...
    <c:if test="${UserPermission.addRights eq 1 }">
         <button type="submit" class="btn btn-default process-footer-button-cancel ng-binding" onclick="redirectToWorkmenBlackView('add')">Add</button> 
    </c:if>
    <c:if test="${UserPermission.editRights eq 1 }">
     ...
     <c:if test="${UserPermission.viewRights eq 1 }">
        <button type="submit" class="btn btn-default process-footer-button-cancel ng-binding" onclick="redirectToWorkmenBlackView('view')">View</button>
...
<tr>
                   ...
                   <%--  <th class="header-text"  onclick="sortTable(8)"><spring:message code="label.vendorCode"/><span id="sortIndicatorBocwApp" class="sort-indicator sort-asc">&#x25B2;</span></th>
                    ...
                    <th class="header-text"  onclick="sortTable(10)"><spring:message code="label.TransactionType"/><span id="sortIndicatorIsmApp" class="sort-indicator sort-asc"></span></th>
					<th class="header-text"  onclick="sortTable(10)"><spring:message code="label.gatePassType"/><span id="sortIndicatorIsmApp" class="sort-indicator sort-asc"></span></th> 
                    <th class="header-text"  onclick="sortTable(11)"><spring:message code="label.status"/><span id="sortIndicatorIsmApp" class="sort-indicator sort-asc"></span></th> 
