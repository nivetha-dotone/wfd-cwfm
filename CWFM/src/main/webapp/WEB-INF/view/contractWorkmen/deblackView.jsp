         ...
         <div class="action-buttons" >
          ...
          <% if (user != null && "Contractor".equals(roleName)) { %>
           ...
           <% } %>
            ...
            <% if (user != null && !"Contractor".equals(roleName)) { %>
    			<button id="approveButton"  type="submit" class="btn btn-default process-footer-button-cancel ng-binding" onclick="approveRejectDeblacklist('4','7')">Approve</button>
   				 <button id="rejectButton"   type="submit" class="btn btn-default process-footer-button-cancel ng-binding" onclick="approveRejectDeblacklist('5','7')">Reject</button>
			<% } %>
...
<th><label class="custom-label"><span class="required-field">*</span><spring:message code="label.ifscCode"/></label></th>
	...
	<td><input style="width: 100%;height: 20px;" type="text"  name="pfCap"  id="pfCap" value="${GatePassObj.pfCap }" readonly/></td>
        ...
        <!-- Add any additional rows for Approver Comments -->
             ...
             <c:if test="${(GatePassObj.gatePassAction eq '1'||GatePassObj.gatePassAction eq '2'||GatePassObj.gatePassAction eq '6') && mode eq 'add' }">
          <% if (user != null && "Contractor".equals(roleName) ) { %>
        ...
        <tr>
				<th><label class="custom-label"><span class="required-field">*</span><spring:message code="label.reasonOfOffboarding"/></label></th>
                            ...
                            <select class="custom-select"  id="reasonofOffboarding" name="reasonofOffboarding" >
        							...
        							<c:forEach var="option" items="${dbl}">
