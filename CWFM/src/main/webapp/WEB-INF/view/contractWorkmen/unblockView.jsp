       ...
       <div class="tabs-container">
        <div class="tabs">
         ...
         <div class="action-buttons" >
          <c:if test="${GatePassObj.gatePassAction eq '4' }">
          <% if (user != null && "Contractor Supervisor".equals(roleName)) { %>
           ...
           <% } %>
            ...
            <% if (user != null && !"Contractor Supervisor".equals(roleName)) { %>
    			<button id="approveButton" style="display:none;" type="submit" class="btn btn-default process-footer-button-cancel ng-binding" onclick="approveRejectUnblock('4','5')">Approve</button>
   				 <button id="rejectButton"  style="display:none;" type="submit" class="btn btn-default process-footer-button-cancel ng-binding" onclick="approveRejectUnblock('5','5')">Reject</button>
			<% } %>
            <button type="submit" class="btn btn-default process-footer-button-cancel ng-binding" onclick="loadCommonList('/contractworkmen/unblockList', 'Unblock List');">Cancel</button>
        </div> 
    </div>
            ...
            <table class="ControlLayout" cellspacing="0" cellpadding="0">
                ...
                <td>
                   <a href="#" onclick="downloadDoc('${GatePassObj.gatePassId}','${GatePassObj.createdBy }','aadhar')">Download Aadhar</a>
            		...
            		<tr>
                		<td style="color:black">Police Verification Document</td>
                <td>
            		...
            		<tr>
                		<td style="color:black">Bank Document</td>
                		<td>
            		...
            		<tr>
                		<td style="color:black">Training Document</td>
                		<td>
            		...
            		<tr>
                		<td style="color:black">Other Document</td>
                		<td>
            		...
            		<tr>
                		<td style="color:black">Id Proof2 Document</td>
                		<td>
            		...
            		<tr>
                		<td style="color:black">Medical Document</td>
                		<td>
            		...
            		<tr>
                		<td style="color:black">Education Document</td>
                		<td>
            		...
            		<tr>
                		<td style="color:black">Form11 Document</td>
                		<td>
