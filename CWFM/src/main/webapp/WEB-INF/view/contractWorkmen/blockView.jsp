         ...
         <c:if test="${GatePassObj.gatePassAction eq '1' }">
          <% if (user != null && "Contractor Supervisor".equals(roleName)) { %>
           ...
           <% } %>
            ...
            <% if (user != null && !"Contractor Supervisor".equals(roleName)) { %>
    			<button id="approveButton" style="display:none;" type="submit" class="btn btn-default process-footer-button-cancel ng-binding" onclick="approveRejectBlock('4','4')">Approve</button>
   				 <button id="rejectButton"  style="display:none;" type="submit" class="btn btn-default process-footer-button-cancel ng-binding" onclick="approveRejectBlock('5','4')">Reject</button>
			<% } %>
            <button type="submit" class="btn btn-default process-footer-button-cancel ng-binding" onclick="loadCommonList('/contractworkmen/blockList', 'Block List');">Cancel</button>
        </div> 
    </div>
