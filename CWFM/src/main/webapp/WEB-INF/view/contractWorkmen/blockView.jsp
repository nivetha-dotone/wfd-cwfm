...
<script src="https://code.jquery.com/ui/1.12.1/jquery-ui.min.js"></script>
 ...
 // Function to validate fields in the current active tab
    ...
    function showTab(tabId) {
     ...
     // Show Approve/Reject only on tab1
    ...
    <div id="principalEmployerContent">
       <div class="tabs-container">
        <div class="tabs">
         ...
         <c:if test="${(GatePassObj.gatePassAction eq '1'||GatePassObj.gatePassAction eq '2') && mode eq 'add' }">
          <% if (user != null && "Contractor".equals(roleName) ) { %>
           ...
           <% } %>
            ...
            <% if (user != null && !"Contractor".equals(roleName)) { %>
    			<button id="approveButton"  type="submit" class="btn btn-default process-footer-button-cancel ng-binding" onclick="approveRejectBlock('4','4')">Approve</button>
   				 <button id="rejectButton"   type="submit" class="btn btn-default process-footer-button-cancel ng-binding" onclick="approveRejectBlock('5','4')">Reject</button>
			<% } %>
            <button type="submit" class="btn btn-default process-footer-button-cancel ng-binding" onclick="loadCommonList('/contractworkmen/blockListFilter', 'Block List');">Cancel</button>
        </div> 
    </div>
        ...
        <tr>
				<th><label class="custom-label"><span class="required-field">*</span><spring:message code="label.reasonOfOffboarding"/></label></th>
                            ...
                            <select class="custom-select"  id="reasonofOffboarding" name="reasonofOffboarding" >
        							...
        							<c:forEach var="option" items="${blk}">
