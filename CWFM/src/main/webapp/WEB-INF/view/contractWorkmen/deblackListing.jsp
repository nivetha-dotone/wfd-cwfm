...
<select id="deptId" name="deptId" style="color:gray;padding:3px;">
    <option value="">Select Department</option>
        ...
        <button type="button" class="btn btn-default process-footer-button-cancel ng-binding"  onclick="searchDeBlackList()">Search</button>
  </div>
    <div>
    <c:if test="${UserPermission.addRights eq 1 }">
         <button type="submit" class="btn btn-default process-footer-button-cancel ng-binding" onclick="redirectToWorkmenDeblackView('add')">Add</button> 
    </c:if>
    <c:if test="${UserPermission.editRights eq 1 }">
     ...
     <c:if test="${UserPermission.viewRights eq 1 }">
        <button type="submit" class="btn btn-default process-footer-button-cancel ng-binding" onclick="redirectToWorkmenDeblackView('view')">View</button>
