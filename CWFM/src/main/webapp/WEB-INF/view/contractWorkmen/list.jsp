...
<head>
 <meta charset="UTF-8">
    ...
    <title>Contract Workmen List</title>
...
<div class="page-header">
       Contract Workmen List
        ...
        <button type="submit" onclick="redirectToWOView()">View</button>
         <button type="button" onclick="workmenListExportToCSV()">Export</button>
        </div>
        </div>
    <form id="searchForm">
 ...
 <label for="contractorId">Contractor :</label>
    ...
    <c:forEach items="${contractors}" var="contractor">
        ...
        <button type="submit" onclick="searchWithPEContractorInWorkmenList()">Search</button>
</form> 
...
<tr>
                    <td style="border: 1px solid black;">
                        <input type="checkbox" id="selectAllContractWorkmenCheckbox" onchange="toggleSelectAllContractWorkmen()">
                    </td> 
        ...
        <tbody>
            <c:forEach items="${persons}" var="wo">
               <tr>
                 <td style="border: 1px solid black;"><input type="checkbox" name="selectedCWs" value="${wo.employeeId}"></td>
