                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button type="button" onclick="generateOtp()"
                                                            class="btn btn-default process-footer-button-cancel ng-binding">Generate
                                                            OTP</button>

                                                    </td>

                                                    <td>
                                                        <input id="otp" name="otp" style="width: 100%;height: 20px;"
                                                            type="text" size="30" maxlength="12" autocomplete="off"
                                                            placeholder="Enter otp here" inputmode="numeric"
                                                            pattern="[0-9]*"
                                                            oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                                                    </td>
                                                    <td> <button type="button"
                                                            class="btn btn-default process-footer-button-cancel ng-binding"
                                                            onclick="verifyOtpDemo()">Verify OTP</button></td>
                                                    <!--  <td rowspan="6" class="image-container">
        <img id="imageId" width="150" height="150" onclick="openFilePicker();">
        <input type="file" id="fileInput" style="display: none;" accept="image/*" onchange="handleFileSelect(event)">
    </td> -->
                                                        ...
                                                        <select class="custom-select" id="eic" name="eicId">
                                                            ...
                                                            <c:forEach var="pe" items="${Eic}">
                                                                <option value="${pe.userId}" ${not empty GatePassObj.eic
                                                                    and GatePassObj.eic.toString()==pe.userId.toString()
                                                                    ? 'selected="selected"' : '' }>
                                                                    ${pe.fullName}
                                                                </option>
                                                    ...
                                                    <td><select class="custom-select" id="wc" name="wcId">
                                                            ...
                                                            <c:forEach var="pe" items="${Wcs}">
                                                                <c:if
                                                                    ...
                                                                    <option value="${pe.wcId}" ${GatePassObj.wcEsicNo eq
                                                    ...
                                                    <td>
                                                        <c:if test="${ empty GatePassObj.esicNumber }">
                                                            <input id="esicNumber" name="esicNumber"
                                                                style="width: 100%;height: 20px;text-transform: capitalize;"
                                                                type="text" size="30" maxlength="10" autocomplete="off"
                                                        ...
                                                        <c:if test="${ not empty GatePassObj.esicNumber }">
                                                            <input id="esicNumber" name="esicNumber"
                                                                ...
                                                                value="${GatePassObj.esicNumber }" autocomplete="off"
                                                                inputmode="numeric" pattern="[0-9]*"
                                                                oninput="this.value = this.value.replace(/[^0-9]/g, '')">

                                                        </c:if>
                                                        <label id="error-esicNumber"
                                                            style="color: red;display: none;">Please enter a valid ESIC
                                                            Number</label>
                                                    </td>
                                                </tr>
                                                <tr>
...
>>>>>>> Stashed changes
                                                        ...
                                                        <span id="imageFileName"
                                                            style="margin-left: 10px; color: black;"></span>
...
=======
                                                    ...
                                                    <td>
                                                        ...
                                                        <span id="aadharFileName"
                                                            style="margin-left: 10px;color:black;"></span>
                                                        <div id="aadharError"></div>
                                                        <!-- Error message for Aadhar file -->
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <label for="policeFile"><span class="required-field">*</span>
                                                            <spring:message
                                                                code="label.uploadPoliceVerificationReport" />
                                                        </label>
                                                        <input type="file" id="policeFile" name="policeFile"
                                                            accept="application/pdf"
                                                            onchange="displayFileName1('policeFile', 'policeFileName')">
                                                        <span id="policeFileName"
                                                            style="margin-left: 10px;color:black;"></span>
                                                        <div id="policeError"></div>
                                                        <!-- Error message for Police file -->
                                                    </td>
                                                    ...
                                                    <td><label for="policeDate"><span class="required-field">*</span>
                                                        ...
                                                        <c:if test="${ empty GatePassObj.policeVerificationDate }">
                                                            <input id="policeVerificationDate"
                                                                name="policeVerificationDate"
                                                                class="datetimepickerformat3"
                                                                style="margin-left: 10px;color:black;" type="text"
                                                        ...
                                                        <c:if test="${ not empty GatePassObj.policeVerificationDate }">
                                                            <input id="policeVerificationDate"
                                                                ...
                                                                value="${ GatePassObj.policeVerificationDate}"
                                                                autocomplete="off">
                                                        </c:if>
                                                        <label id="error-policeVerificationDate"
                                                            style="color: red;display: none;">Please enter a valid
                                                            Police Verification Date </label>
                                                    </td>
				...
				<td><input type="textarea" name="value(prevComment)" style="width:220px;height:100px;text-transform: capitalize;" readonly="true" cols="35" rows="7"  onchange="setDataChanged();"/></td>
				 -->
                                                    ...
                                                    <td><textarea id="comments" name="comments"
                                                        ...
                                                        <label id="error-comments"
                                                            style="color: red;display: none;">Enter comments</label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                </tr>
                                                <tr>
                                                    <td colspan="6"
                                                        ...
                                                        <b>
                                                            <input type="checkbox" name="acceptCheck"
                                                                id="acceptCheck" />
                                                            I hereby certify that the details given above are true and
                                                            correct to the best of my or our knowledge and belief, and
                                                            nothing has been concealed herein. I or my company will take
                                                            full responsibility for the conduct and behavior of the
                                                            persons engaged by me or our company to work or visit
                                                            premises. I/we will ensure that they are briefed on all
                                                            traffic, safety, and security rules and procedures of
                                                            company where they have been engaged by us for work. In case
                                                            of any breach or violation of rules, regulations, safety
                                                            policy, or other applicable procedures by the above person,
                                                            we will be solely responsible and liable for suitable action
                                                            as per company's safety and security policy
                                                        </b>
                                                        <label id="acceptError" style="color: red;display: none;">You
                                                            must accept the declaration</label>
                                                    </td>
                                                </tr>
                                                <!-- <tr >
