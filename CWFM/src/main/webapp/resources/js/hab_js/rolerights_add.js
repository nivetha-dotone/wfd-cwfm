...
function setRights() { 
    ...
    var import_right = document.getElementById('add_rolerights_import_right').value.split('(~)'); 
    var forward_right = document.getElementById('add_rolerights_forward_right').value.split('(~)');
    var assign_right = document.getElementById('add_rolerights_assign_right').value.split('(~)');
    var complete_right = document.getElementById('add_rolerights_complete_right').value.split('(~)');
    var view_right = document.getElementById('add_rolerights_view_right').value.split('(~)'); 
    var flag_yes = 'Yes';
    var value = 25;
    if (add_right[0] == value || delete_right[0] == value || edit_right[0] == value || export_right[0] == value || import_right[0] == value || forward_right[0] == value || assign_right[0] == value || complete_right[0] == value || view_right[0] == value) {
        document.getElementById('add_rolerights_list_right').value = value+'(~)'+flag_yes;
    }
}
...
function setRights_Basedon_list() { 
    ...
    if (list_right[0] == value) { 
        ...
        document.getElementById('add_rolerights_import_right').value = document.getElementById('add_rolerights_list_right').value;
        document.getElementById('add_rolerights_forward_right').value = document.getElementById('add_rolerights_list_right').value;
        document.getElementById('add_rolerights_assign_right').value = document.getElementById('add_rolerights_list_right').value;
        document.getElementById('add_rolerights_complete_right').value = document.getElementById('add_rolerights_list_right').value;
