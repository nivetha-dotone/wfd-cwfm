...
//   }
   ...
   function zero(){
		var a = document.getElementById('answer_sequence_id').value;
		if(a == null || a == "")
			document.getElementById('answer_sequence_id').value=0;
		if(a != null || a != "")
			document.getElementById('answer_sequence_id').value=parseInt(document.getElementById('answer_sequence_id').value);
	}
   function depend(){
		var a = document.getElementById('add_company_id').value;
		if(a == null || a == ""){
			document.getElementById('add_question_mandatory_id').value=null;
			document.getElementById('add_answer_description_id').value=null;
