...
=====================================*/
function sidebaroff(){
   document.getElementById("sidebar-off").setAttribute('disabled','disabled');
   document.getElementById("sidebar-on").removeAttribute('disabled');
   document.getElementById("sidebar").className  = "side-hide";
   document.getElementById("right-sidebar").setAttribute('disabled','disabled');
   document.getElementById("left-sidebar").setAttribute('disabled','disabled');
   $('.top-nav').addClass('full-fluid');
   $('#main-content').addClass('full-fluid');
   var baseurl=document.getElementById('baseurl').value.trim();
   var url=baseurl+'ctrl_login/sidebar/side-hide';
   ajax(url,'theme_div_id');
}
function sidebaron(){
   document.getElementById("sidebar-off").removeAttribute('disabled');
   document.getElementById("sidebar-on").setAttribute('disabled','disabled');
   document.getElementById("sidebar").className  = "";
   $('.top-nav').removeClass('full-fluid');
   $('#main-content').removeClass('full-fluid');
   var baseurl=document.getElementById('baseurl').value.trim();
   var url=baseurl+'ctrl_login/sidebar/';
   ajax(url,'theme_div_id');
   document.getElementById("left-sidebar").removeAttribute('disabled');
   document.getElementById("right-sidebar").removeAttribute('disabled');
...
function sidebarright(){
   document.getElementById("left-sidebar").removeAttribute('disabled');
   document.getElementById("right-sidebar").setAttribute('disabled','disabled');
   document.getElementById("sidebar").className  = "right-sidebar";
   $('.top-nav').addClass('merge-left');
   $('#main-content').addClass('merge-left');
   var baseurl=document.getElementById('baseurl').value.trim();
   var url=baseurl+'ctrl_login/sidebar/right-sidebar';
   ajax(url,'theme_div_id');
}
   ...
   ajax(url,'theme_div_id');
	...
	/*$(function()
	{
		...
		/*$(function()
		{
			...
			{       var baseurl=document.getElementById('baseurl').value.trim();theme();
				var stylesheet = $(this).attr('title').toLowerCase();
				$('#themes').attr('href',baseurl+'css'+'/'+stylesheet+'.css');
				});
			});*/
