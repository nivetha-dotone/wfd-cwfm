...
function add_rolerights_record() {
    ...
    window.location.href = base_url + 'ctrl_roles/add';
}
function view_record() {
    if (selectedrecordid === '' || selectedrecordid === null) {
        ...
        if (base_url === '' || base_url === null)
            base_url = document.getElementById('base_url').value;
        window.location.href = base_url + 'ctrl_roles/view/' + id;
    }
}
function delete_record() {
    if (selectedrecordid === '' || selectedrecordid === null) {
        ...
        if (base_url === '' || base_url === null)
            base_url = document.getElementById('base_url').value;
        window.location.href = base_url + 'ctrl_roles/deleteconformation/' + id;
    }
}
function export_records() {
    ...
    if (base_url === '' || base_url === null)
        base_url = document.getElementById('base_url').value;
    window.location.href = base_url + 'ctrl_roles/toExport/' + search;
}
function edit_page() {
    if (selectedrecordid === '' || selectedrecordid === null) {
        if (p_s_record === '' || p_s_record === null)
        ...
        if (base_url === '' || base_url === null)
            base_url = document.getElementById('base_url').value;
        window.location.href = base_url + 'ctrl_roles/edit_view/' + id;
    }
}
function groups() {
    if (selectedrecordid === '') {
        ...
        if (base_url === '' || base_url === null)
            base_url = document.getElementById('base_url').value;
        window.location.href = base_url + 'ctrl_groups/index/' + id + '/' + 'roles';
    }
}
function permissions() {
    if (selectedrecordid === '') {
        ...
        if (base_url === '' || base_url === null)
            base_url = document.getElementById('base_url').value;
        window.location.href = base_url + 'ctrl_permissions/index/' + id + '/' + 'roles';
    }
}
function users() {
    if (selectedrecordid === '') {
        ...
        if (base_url === '' || base_url === null)
            base_url = document.getElementById('base_url').value;
        window.location.href = base_url + 'ctrl_users/index/' + id + '/' + 'roles';
    }
}