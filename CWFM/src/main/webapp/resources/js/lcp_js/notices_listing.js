...
function add() {
    ...
    window.location.href = base_url + 'ctrl_notifications/add/';
}
function view() {
    if (selectedrecordid == "") {
        ...
        if (base_url == '' || base_url == null)
            base_url = document.getElementById('base_url').value;
        window.location.href = base_url + 'ctrl_notifications/view/' + id;
    }
}
function deletenotice() {
    if (selectedrecordid == "" || selectedrecordid == null) {
        ...
        if (base_url == '' || base_url == null)
            base_url = document.getElementById('base_url').value;
        window.location.href = base_url + 'ctrl_notifications/deleteconformation/' + id;
    }
}
function export_notifications_records() {
    ...
    if (base_url == '' || base_url == null)
        base_url = document.getElementById('base_url').value;
    window.location.href = base_url + 'ctrl_notifications/toExport/' + search;
}
