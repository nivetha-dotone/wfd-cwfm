    ...
    function add() {
       var base_url = document.getElementById('base_url').value.trim();
        ...
        window.location.href = base_url+'ctrl_answers/add';
    }
    function edit() {
       var base_url = document.getElementById('base_url').value.trim();
      ...
      if(selectedrecordid === '' || selectedrecordid === null){
         ...
         window.location.href=base_url+'ctrl_answers/edit/'+id;
      }
    }
    ...
    var val_msg2 = document.getElementById('val_msg2').value.trim();
      if(selectedrecordid === '' || selectedrecordid === null){
         ...
         var id=selectedrecordid;uncheckRadioButton();
         window.location.href=base_url+'ctrl_answers/delete/'+id;
      }
    }
    ...
    var val_msg2 = document.getElementById('val_msg2').value.trim();
      if(selectedrecordid === '' || selectedrecordid === null){
         ...
         var id=selectedrecordid;uncheckRadioButton();
         window.location.href=base_url+'ctrl_answers/view/'+id;
      }
    }
     function export_records() {
      ...
      if(search==='' || search=== null) search= 'empty';
         window.location.href=base_url+'ctrl_answers/toExport/'+search;
   }
