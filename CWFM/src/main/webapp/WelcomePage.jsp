<%@ page import="com.wfd.dot1.cwfm.entity.User" %>
...
%>
    ...
    <div class="top-nav">
        ...
        <div class="heading">Contract Labor Management System</div>
         <div class="dropdown">
             <span class="initials-icon"><c:out value="${sessionScope.userInitials}" /></span> <span><c:out value="${sessionScope.loginuser.fullname}" /></span>
  ...
  <li>
            ...
            <li>
                ...
                <ul class="sub-menu" id="workmen-onboarding-sub-menu">
                    <li><a href="#" onclick="loadCommonList('/contractworkmen/quickOnbordingList', 'Quick On-Bording List')">List</a></li>
                    <li><a href="#" onclick="loadCommonList('/contractworkmen/addQuickOB', 'Quick On-Bording Add')">QOB</a></li>
