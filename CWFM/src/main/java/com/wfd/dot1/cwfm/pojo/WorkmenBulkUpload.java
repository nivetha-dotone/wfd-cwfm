...
public class WorkmenBulkUpload {
	...
	public String getWageCategoryId() {
		return wageCategoryId;
	}
	public void setWageCategoryId(String wageCategoryId) {
	...
	public String getPresentTaluka() {
		return presentTaluka;
	}
	public void setPresentTaluka(String presentTaluka) {
		this.presentTaluka = presentTaluka;
	}
