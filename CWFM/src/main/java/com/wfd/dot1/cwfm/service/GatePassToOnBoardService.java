...
=======
    ...
    public String getDetailsByTransactionIDQuery() {
...
//                dto.(rs.getString("IfscCode")); PayRoll Id
    ...
    public String getSkillDetailsByTransactionIDQuery() {
