...
function validation() {
    var permission_name = document.getElementById('add_permissions_permissioname_id').value;
    ...
    var page_name = document.getElementById('add_permissions_pagename_id').value;
    page_name = $.trim(page_name);
    var action_name = document.getElementById('add_permissions_actionname_id').value;
    ...
    var pagen_valid = document.getElementById('pagename_cannot_beblank').value;
    pagen_valid = $.trim(pagen_valid);
    var acton_valid = document.getElementById('actionname_cannot_beblank').value;
    acton_valid = $.trim(acton_valid);
    if (permission_name === '' || permission_name === null) {
        ...
        document.getElementById("errormsg").innerHTML = pagen_valid;
        return false;
    } else if (action_name === '' || action_name === null) {
        document.getElementById("errormsg").innerHTML = acton_valid;
        return false;
    } else {
        selectallascorgs();
...
function selectallascorgs() {
    var grpass = document.getElementById('add_permission_group_associations_id');
    ...
    var roleass = document.getElementById('add_permissionrole_associations_id');
